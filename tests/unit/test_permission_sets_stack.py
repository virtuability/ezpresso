...
class TestPermissionSetsStack():
    ...
    def test_permission_set_assignments(self):
        ...
        properties = {
            ...
            "github_repo": "mjvirt/expresso",
            "github_repo_branch": "feature/refactor",
            "sso_instance_arn": "arn:aws:sso:::instance/ssoins-1234567890abcdef",
            "identity_store": "d-12345677890",
        }

        stack = PermissionSetsStack(app, "PermissionSets",
        ...
        template.has_resource_properties("AWS::SSO::PermissionSet", {
        ...
        template.has_resource_properties("AWS::SSO::Assignment", {
            "InstanceArn": "arn:aws:sso:::instance/ssoins-1234567890abcdef",
            "PermissionSetArn": {
            "Fn::GetAtt": [
                "PermissionSetDevelopment",
                "PermissionSetArn"
            ]
            },
